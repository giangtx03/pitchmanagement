...
public class MailConstant {
    ...
    public static final String REGISTRATION_CONFIRMATION =
            ...
            "</div>" +
            "<p style=\"font-size: 16px; line-height: 1.6; color: #555;\">Xin chào {username},</p>" +
            ...
            "<a href=\"{confirmationLink}\" style=\"display: inline-block; padding: 12px 25px; background-color: #4CAF50; color: #ffffff; text-decoration: none; border-radius: 5px; font-size: 16px; margin-top: 20px;\">Xác nhận tài khoản</a>" +
    ...
    public static final String FORGOT_PASSWORD =
            "<!DOCTYPE html>" +
                    ...
                    "<a href=\"{confirmationLink}\" style=\"display: inline-block; padding: 12px 25px; background-color: #4CAF50; color: #ffffff; text-decoration: none; border-radius: 5px; font-size: 16px; margin-top: 20px;\">Cập nhật mật khẩu</a>" +
                    "<div style=\"margin-top: 30px; font-size: 12px; color: #999;\">" +
                    "<p style=\"margin: 5px 0;\">Need help? Contact us at <a href=\"mailto:support@example.com\" style=\"color: #4CAF50; text-decoration: none;\">support@example.com</a>.</p>" +
                    "<p style=\"margin: 5px 0;\">&copy; 2024 Your Company. All rights reserved.</p>" +
                    "</div>" +
